...
FH Switch v3.10.0 新增 OpenCode 支持，成为第四个受管理的 CLI 应用。
...
| 文件                                     | 说明                                |
| ---------------------------------------- | ----------------------------------- |
| `FHSwitch-v3.10.0-Windows.msi`          | **推荐** - MSI 安装包，支持自动更新 |
| `FHSwitch-v3.10.0-Windows-Portable.zip` | 便携版，解压即用，不写入注册表      |

### macOS

| 文件                             | 说明                                                      |
| -------------------------------- | --------------------------------------------------------- |
| `FHSwitch-v3.10.0-macOS.zip`    | **推荐** - 解压后拖入 Applications 即可，Universal Binary |
| `FHSwitch-v3.10.0-macOS.tar.gz` | 用于 Homebrew 安装和自动更新                              |
