...
**[中文更新说明 Chinese Documentation →](https://github.com/burnworld3d/fhswitch/blob/main/docs/release-notes/v3.6.0-zh.md)**
...
- Download `FHSwitch-v3.6.0-macOS.zip` from [Assets](#assets) below
...
- **Installer**: `FHSwitch-v3.6.0-Windows.msi`
- **Portable**: `FHSwitch-v3.6.0-Windows-Portable.zip`

### Linux

- **AppImage**: `FHSwitch-v3.6.0-Linux.AppImage`
- **Debian**: `FHSwitch-v3.6.0-Linux.deb`
...
**Full Changelog**: https://github.com/burnworld3d/fhswitch/compare/v3.5.1...v3.6.0
