...
**[中文更新说明 Chinese Documentation →](https://github.com/burnworld3d/fhswitch/blob/main/docs/release-notes/v3.6.1-zh.md)**
...
- Download `FHSwitch-v3.6.1-macOS.zip` from [Assets](#assets) below
...
- **Installer**: `FHSwitch-v3.6.1-Windows.msi`
- **Portable**: `FHSwitch-v3.6.1-Windows-Portable.zip`

#### Linux

- **AppImage**: `FHSwitch-v3.6.1-Linux.AppImage`
- **Debian**: `FHSwitch-v3.6.1-Linux.deb`

---

### 📚 Documentation

- [中文文档 (Chinese)](https://github.com/burnworld3d/fhswitch/blob/main/README_ZH.md)
- [English Documentation](https://github.com/burnworld3d/fhswitch/blob/main/README.md)
- [完整更新日志 (Full Changelog)](https://github.com/burnworld3d/fhswitch/blob/main/CHANGELOG.md)
...
**Full Changelog**: https://github.com/burnworld3d/fhswitch/compare/v3.6.0...v3.6.1
...
- **Customizable Storage Location** - Customize FH Switch's configuration storage directory
...
FH Switch is a cross-platform desktop application for managing and switching between different provider configurations for Claude Code and Codex. Built with Tauri 2.0 + React 18 + TypeScript, supporting Windows, macOS, and Linux.
...
**Project Repository**: https://github.com/burnworld3d/fhswitch
