...
- **ArchLinux Installation Support** (#259)
  Added AUR installation method: `paru -S fhswitch-bin`
...
Visit [Releases](https://github.com/burnworld3d/fhswitch/releases/latest) to download the latest version
...
- **Deep link integration** - Import via `fhswitch://` protocol
...
v3.7.0 represents a shift in FH Switch's positioning:
...
Visit [Releases](https://github.com/burnworld3d/fhswitch/releases/latest) to download:

- **Windows**: `FHSwitch-Windows.msi` or `-Portable.zip`
- **macOS**: `FHSwitch-macOS.tar.gz` or `.zip`
- **Linux**: `FHSwitch-Linux.AppImage` or `.deb`
- **ArchLinux**: `paru -S fhswitch-bin`
...
- [@burnworld3d](https://github.com/burnworld3d) - From developer to issue responder
...
[Register with "fhswitch" code for 10% discount](https://www.packyapi.com/register?aff=fhswitch)
...
- **Issues**: [GitHub Issues](https://github.com/burnworld3d/fhswitch/issues)
- **Discussions**: [GitHub Discussions](https://github.com/burnworld3d/fhswitch/discussions)
