...
- **ArchLinux 安装支持** (#259)
  添加 AUR 安装方式：`paru -S fhswitch-bin`
...
访问 [Releases](https://github.com/burnworld3d/fhswitch/releases/latest) 下载最新版本
...
访问 [Releases](https://github.com/burnworld3d/fhswitch/releases/latest) 下载：

- **Windows**：`FHSwitch-Windows.msi` 或 `-Portable.zip`
- **macOS**：`FHSwitch-macOS.tar.gz` 或 `.zip`
- **Linux**：`FHSwitch-Linux.AppImage` 或 `.deb`
...
- [@burnworld3d](https://github.com/burnworld3d) - 从开发沦为 issue 回复机
- 社区成员的测试和反馈
...
[使用 "fhswitch" 优惠码注册享 9 折优惠](https://www.packyapi.com/register?aff=fhswitch)
...
- **问题反馈**：[GitHub Issues](https://github.com/burnworld3d/fhswitch/issues)
- **讨论**：[GitHub Discussions](https://github.com/burnworld3d/fhswitch/discussions)
