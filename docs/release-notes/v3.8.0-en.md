...
FH Switch v3.8.0 is a major architectural upgrade that restructures the data persistence layer and user interface, laying the foundation for future cloud sync and local proxy features.
...
- **Windows**: `FHSwitch-v3.8.0-Windows.msi` or `-Portable.zip`
- **macOS**: `FHSwitch-v3.8.0-macOS.tar.gz` or `.zip`
- **Linux**: `FHSwitch-v3.8.0-Linux.AppImage` or `.deb`
...
- [@burnworld3d](https://github.com/burnworld3d) - Bug fixes and feature enhancements
...
[Use code "fhswitch" for 10% off registration](https://www.packyapi.com/register?aff=fhswitch)
...
- **Issue Reports**: [GitHub Issues](https://github.com/burnworld3d/fhswitch/issues)
