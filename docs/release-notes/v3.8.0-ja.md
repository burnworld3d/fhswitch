...
FH Switch v3.8.0 はデータ永続化レイヤーと UI を大幅に作り替え、今後のクラウド同期やローカルプロキシ機能に向けた基盤を整えたメジャーアップデートです。
...
[Releases](https://github.com/burnworld3d/fhswitch/releases/latest) から入手:

- **Windows**: `FHSwitch-v3.8.0-Windows.msi` または `-Portable.zip`
- **macOS**: `FHSwitch-v3.8.0-macOS.tar.gz` または `.zip`
- **Linux**: `FHSwitch-v3.8.0-Linux.AppImage` または `.deb`
...
- [@burnworld3d](https://github.com/burnworld3d) - バグ修正と機能拡張
...
[登録時に「fhswitch」で 10% オフ](https://www.packyapi.com/register?aff=fhswitch)
...
- **Issue**: [GitHub Issues](https://github.com/burnworld3d/fhswitch/issues)
