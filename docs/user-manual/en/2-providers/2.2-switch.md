...
2. FH Switch updates the configuration file
...
1. Right-click the FH Switch icon in the system tray
...
When switching providers, FH Switch modifies the following files:
