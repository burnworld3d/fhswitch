...
FH Switch provides rich icon customization features:
...
This ensures FH Switch and CLI tool configurations stay in sync.
...
When adding a provider, FH Switch automatically extracts endpoint URLs from the configuration.
