...
When enabling an app's toggle, FH Switch will:
...
When disabling an app's toggle, FH Switch will:
...
If you have already configured MCP servers in CLI tools, you can import them into FH Switch:

1. Click the "Import" button
2. Select the app to import from (Claude/Codex/Gemini/OpenCode)
3. FH Switch reads the existing configuration and imports it
