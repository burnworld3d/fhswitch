...
FH Switch provides a smart backfill protection mechanism to ensure your manual modifications are not lost.
...
```
fhswitch://import/prompt?data=<base64-encoded preset>
```
