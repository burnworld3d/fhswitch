...
sequenceDiagram
    ...
    participant Proxy as Local Proxy (FH Switch)
...
After starting the proxy and enabling app takeover, FH Switch modifies app configurations:
...
When stopping the proxy, FH Switch will:
