//! Deep link import functionality for FH Switch
//!
//! This module implements the fhswitch:// protocol for importing configurations
...
///
/// Represents a parsed fhswitch:// URL ready for processing.
