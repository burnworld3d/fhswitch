...
//!
//! Parses fhswitch:// URLs into DeepLinkImportRequest structures.
...
/// Parse a fhswitch:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// fhswitch://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "fhswitch" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'fhswitch', got '{scheme}'"
        )));
    }
